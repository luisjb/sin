 ...
 * @author gcastillo
 */
public class QendraHandlerHanbai {
    ...
    public boolean connectDB(String path) throws ClassNotFoundException {
        try {
            ...
            System.out.println("Driver firebird version: " + org.firebirdsql.jdbc.FBDriver.class.getPackage().getImplementationVersion());            
            //customLogger.writeLog(MainApp.INFO, "Driver firebird version:", org.firebirdsql.jdbc.FBDriver.class.getPackage().getImplementationVersion());
            ...
            //connectionProperties.put("sql_dialect", "3");
     ...
     * @throws SQLException
     */
    private void doDepartment(GeneralPlu ibdata) throws SQLException {
        ...
        psDpt.setString(2, ibdata.seccion_nombre);
//System.out.println("DEPA " +ibdata.seccion);
     ...
     * @throws SQLException
     */
    private void doOrigen(GeneralPlu ibdata) throws SQLException {
...
//System.out.println("ORI " + ibdata.cod_proveedor + ibdata.desc_proveedor);
     ...
     * @throws SQLException
     */
    private void doDatosConserv(GeneralPlu ibdata) throws SQLException {
...
//System.out.println("CONS " + ibdata.cod_conservacion + ibdata.desc_conservacion);
     ...
     * @throws SQLException
     */
    private void doIngredientes(GeneralPlu ibdata) throws SQLException {
     ...
     * @throws SQLException
     */
    private void doProduct(GeneralPlu ibdata, int number) throws SQLException {
        ...
        try {
            ...
            psPlu.setLong(the_number, ibdata.codigo_plu); // INTEGER,
            ...
            psPlu.setLong(the_codigo, ibdata.codigo_plu); // INTEGER,
            ...
            //psPlu.setString(the_ean_cfg, (ibdata.primary_barcode_data.trim().isEmpty() ? "" : ibdata.primary_barcode_data)); // VARCHAR(12)
            psPlu.setString(the_ean_cfg, ""); // VARCHAR(12)
//System.out.println("PROD " + number + ibdata.nombre);
            psPlu.execute();
        } catch (Exception e) {
            customLogger.writeLog(MainApp.ERROR, "localhost", "Importando a la DB de Qendra error: " + e.toString());
        }
     ...
     * @throws SQLException
     */
    public void InsertProduct(GeneralPlu ibdata, long number) throws Exception {
        try {
            ...
            Logger.getLogger(QendraHandlerHanbai.class.getName()).log(Level.SEVERE, null, e);
        }
    }
    ...
    private void doDBUpdate() {
        try {
            ...
            Logger.getLogger(QendraHandlerHanbai.class.getName()).log(Level.SEVERE, null, ex);
        }
